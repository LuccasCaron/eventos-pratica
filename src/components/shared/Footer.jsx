  ...
  return (
    <footer className="bg-[#0f172a] text-white pt-10 pb-6 mt-12">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8 text-sm">
        {/* Institucional */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-cyan-400">L&L Eventos</h3>
          <p className="text-gray-400">
            Especialistas em tornar seu evento inesquecível. Qualidade, compromisso e paixão por realizar.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/formulario" className="hover:underline text-gray-300">Formulário</a></li>
            <li><a href="/agendamento" className="hover:underline text-gray-300">Agendamento</a></li>
            <li><a href="/chat" className="hover:underline text-gray-300">Chat</a></li>
          </ul>
        </div>
